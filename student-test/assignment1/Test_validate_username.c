...
void test_validate_my_username()
{
    ...
    //TEST_ASSERT_TRUE_MESSAGE((strstr(Conf_username,username)!= NULL),"AESD students, please fix me!");
    TEST_ASSERT_EQUAL_STRING_MESSAGE(Conf_username,username,"AESD students, please fix me!");
}
